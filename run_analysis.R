...
X_test <- read.table("test/X_test.txt") 					##reading X_test to X_test data frame
X_train <- read.table("train/X_train.txt") 				##reading X_train to X_train data frame

Y_test <- read.table("test/Y_test.txt") 					##reading Y_test to Y_test data frame
Y_train <- read.table("train/Y_train.txt") 				##reading Y_train to Y_train data frame

subject_test <- read.table("test/subject_test.txt") 		##reading subject_test to subject_test data frame
subject_train <- read.table("train/subject_train.txt") 	##reading subject_train to subject_train data frame

features<-read.table("features.txt") 					##reading features to features data frame
...
write.table(Tidydata,"tidydata.txt")	## tidy data will be generated in the specified path
